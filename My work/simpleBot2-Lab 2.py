...
class Counter:
    def __init__(self,canvas):
        ...
        canvas.create_text(70,50,text="Dirt collected: "+str(self.dirtCollected),tags="counter")

    def itemCollected(self,canvas):
        self.dirtCollected=self.dirtCollected+1
        canvas.itemconfigure("counter",text="Dirt collected: "+str(self.dirtCollected))
